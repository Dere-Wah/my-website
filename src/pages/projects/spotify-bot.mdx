...
If you want to view the bot check out this github repo: [**https://github.com/Dere-Wah/SpotifyFollowers**](https://github.com/Dere-Wah/SpotifyFollowers)
...
Eventually, since the endpoint became rate-limited and the project was well-protected, I published [**a revised version of the follow bot and scraper**](https://github.com/Dere-Wah/SpotifyFollowers) on GitHub. **Note:** This method no longer works!
