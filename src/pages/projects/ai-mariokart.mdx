...
export const components = {pre: CodeBlock, code: Code, strong: Bold, hr: Divider, img: BlogImage, h1: Header1, h2: Header2, p: Paragraph, ol: OrderedList, ul: UnorderedList}
...
<div class="text-ebony-clay-50 flex flex-row gap-1">
<Shield icon="twemoji:hugging-face" url="https://huggingface.co/DereWah/diamond-mariokart64" >Model</Shield>
<Shield icon="twemoji:hugging-face" url="https://huggingface.co/datasets/DereWah/mk64-steering" >Dataset</Shield>
<Shield icon="mdi:github" url="https://github.com/Dere-Wah/AI-MarioKart64">Codebase</Shield>
<Shield icon="mdi:discord" url="https://discord.gg/uMF94QreGc">Discord</Shield>
</div>

![The resulting simulated game.](public/assets/blog/ai-mariokart/aimk64.gif)
...
![The original model trained on CSGO.](public/assets/blog/ai-mariokart/csgo.gif)
...
![The first version of AISM64.](public/assets/blog/ai-mariokart/sm64ai.gif)
...
![The dataset collection script (this is from when it was collecting SM64, so just 11 inputs instead of 20)](public/assets/blog/ai-mariokart/vectors_dataset.png)
...
![How a dataset looks like from the outside](public/assets/blog/ai-mariokart/dataset_hdf5.png)
...
![Processing the tar files](public/assets/blog/ai-mariokart/processing_tar_files.png)
...
![Adjusting to fill the GPU on colab](public/assets/blog/ai-mariokart/filling_gpu.png)
...
Based on your description and tests, the final parameter values were:
...
![Outputs](public/assets/blog/ai-mariokart/checkpoints.png)
...
![Adjusting to fill the GPU on colab](public/assets/blog/ai-mariokart/spawn.png)
...
3. **Stack and Save the Tensors:**
   After extracting all data, stack the tensors for full-res, low-res frames, and actions. Rearrange the dimensions of the images to match the required format: `(FRAME_NUMBER, COLOR_CHANNELS, HEIGHT, WIDTH)`.
