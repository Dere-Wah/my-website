...
With the trained model ready, the next task is deploying it for gameplay. DIAMOND uses the trained model to predict steering vectors based on real-time emulator frames.

---

# Your Model Is Trained! Time to Play It
