...
date: "2024-10-24"
description: "A devlog about the first game jam I ever took place in (Brackeys Game Jam 2024.2)."
tags: ["AI", "Game Dev"]
published: true
---
...
One thing worth noting is that I had just finished developing my first-ever web-based game, called <Shield icon="twemoji:detective" url="https://spyfall.derewah.dev">SpyFall</ Shield>. It was a social deduction game with a React front-end and a backend server for networking. Having just taught myself React, I was still fresh with excitement from that project (you can read more about it in another blog post <Shield icon="mdi:alpha-d-circle-outline" url="./spyfall ">HERE</ Shield>).
...
<video controls class="w-full flex flex-row justify-center aspect-video">
  <source src={import("../src/assets/blog/twister/logging_in.mp4")} type="video/mp4" />
</ video>
...
<video controls class="w-full flex flex-row justify-center aspect-video">
  <source src={import("./src/assets/blog/twister/comments.mp4")} type="video/mp4" />
</ video>
...
<video controls class="w-full flex flex-row justify-center aspect-video">
  <source src="../src/assets/blog/twister/progress.mp4" type="video/mp4" />
</ video>
...
<video controls class="w-full flex flex-row justify-center aspect-video">
  <source src="../src/assets/blog/twister/deletion.mp4" type="video/mp4" />
</ video>
...
<video controls class="w-full flex flex-row justify-center aspect-video">
  <source src="../src/assets/blog/twister/penguinz0.mp4" type="video/mp4" />
</ video>
...
<video controls class="w-full flex flex-row justify-center aspect-video">
  <source src="../src/assets/blog/twister/full.mp4" type="video/mp4" />
</ video>
...
<Paragraph subtitle="The website says #7, but the original #1 submission was disqualified for manipulating votes in their favour" />
